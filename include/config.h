 ...
 */
#define PINO_OLED_SDA   21    // GPIO21 -> Linha de Dados (SDA)
#define PINO_OLED_SCL   22    // GPIO22 -> Linha de Clock (SCL)
 ...
 */
#define PINO_RFID_SDA   5     // GPIO05 -> Slave Select (SS / CS)
#define PINO_RFID_SCK   18    // GPIO18 -> Serial Clock (SCK)
#define PINO_RFID_MISO  19    // GPIO19 -> Master In Slave Out (MISO)
#define PINO_RFID_MOSI  23    // GPIO23 -> Master Out Slave In (MOSI)
#define PINO_RFID_RST   27    // GPIO27 -> Reset lógico por hardware (RST)

/*
 * Mapeamento de Atuadores
 */
#define PINO_RELE_TRAVA 17    // GPIO17 -> Comando do Módulo Relé (Trava Solenoide / LED)

/*
 * Mapeamento de Sensores e Botões (Entradas Digitais)
 */
#define PINO_FIM_DE_CURSO   4   // GPIO04 -> Validador de Porta (Módulo YL-99 / Slide Switch)
#define PINO_BOTAO_AZUL     12  // GPIO12 -> Botão Azul
#define PINO_BOTAO_VERDE    13  // GPIO13 -> Botão Verde
#define PINO_BOTAO_VERMELHO 14  // GPIO14 -> Botão Vermelho
